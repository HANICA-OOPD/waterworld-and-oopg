...
public class FilePersistenceTest {
    ...
    public void saveAndLoadDataTest() {
    	String expected = "testtesttesttesttesttesttesttest";
        filePersistence.saveData(expected);
        String actual = filePersistence.loadDataString();
    ...
    @Test
    public void deleteANotExistingFile() {
